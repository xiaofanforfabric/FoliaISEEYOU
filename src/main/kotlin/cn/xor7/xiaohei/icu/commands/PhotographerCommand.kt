...
import cn.xor7.xiaohei.icu.utils.isPhotographerSupported
            ...
            locationArgument("location", optional = true) {
                worldArgument("world", optional = true) {
                    anyExecutor { sender, args ->
                        ...
                        if (!isPhotographerSupported()) {
                            sender.sendError("Photographer not supported on this server. Use Leaves for recording.")
                            return@anyExecutor
                        }
                        ...
                        sender.sendSuccess("Photographer '${photographer.name}' created at ${photographer.world?.name ?: "?"} (${photographer.location?.blockX ?: 0}, ${photographer.location?.blockY ?: 0}, ${photographer.location?.blockZ ?: 0})")
                    }
                }
            }
        }
